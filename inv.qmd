...
my.edge.colors<-rep("gray80",length(tr$edge.length))
my.edge.colors[cladeEXObranches]<-"dodgerblue3"
my.edge.colors[cladeNATbranches]<-"gray80"
my.edge.colors[cladeBOTHbranches]<-"brown"

plot(tr,show.tip.label=F,edge.color=my.edge.colors,edge.width=0.5,direction="downwards",cex=0.3,label.offset=0)#,x.lim=c(0,1200))
